...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_pikchr')) {
        Object.defineProperty(Module['ready'], '_pikchr', { configurable: true, get: function() { abort('You are getting _pikchr on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_pikchr', { configurable: true, set: function() { abort('You are setting _pikchr on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var STACK_BASE = 5268192,
    STACKTOP = STACK_BASE,
    STACK_MAX = 25312,
    DYNAMIC_BASE = 5268192;
...
var asmLibraryArg = { "__assert_fail": ___assert_fail, "__indirect_function_table": wasmTable, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "exit": _exit, "memory": wasmMemory };
var asm = createWasm();
/** @type {function(...*):?} */
var ___wasm_call_ctors = Module["___wasm_call_ctors"] = createExportWrapper("__wasm_call_ctors");

/** @type {function(...*):?} */
var _pikchr = Module["_pikchr"] = createExportWrapper("pikchr");
